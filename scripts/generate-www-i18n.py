...
TOPICS: dict[str, dict[str, dict[str, Any]]] = {
    "download": {
        "en": {"title": "Download Automic Vault", "description": "Download Automic Vault for macOS to protect developer credentials and check Tool operations before use.", "kicker": "Download", "h1": "Download Automic Vault for macOS", "lede": "Move supported credentials out of plaintext files and check each Tool operation on your Mac.", "sections": [["Direct download", "Download the signed .dmg, open Automic Vault, and follow the setup guide to install the av command-line tool."], ["App and CLI", "The native app manages Authorization Gates, Project Values, Launcher Bundles, Temporary Access Grants, Tool Hardening, and local Authorization History."], ["After installation", "Run av scan, harden a supported Tool, then choose which recognized operations each Verified Launcher may run."]]},
...
LLMS_COPY: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "docsDescription": "Automic Vault のアプリ、Approval、Project Values、Launcher Bundles、プロキシ、GPG Signing、CLI を解説する英語のマニュアルです。4.12.2 のソースで確認されています。",
        ...
        "facts": "基本情報",
        "platform": "対応環境: macOS",
        "release": "現在のドキュメント対象リリース: Automic Vault 4.12.2",
    ...
    "de": {
        ...
        "docsDescription": "Englisches Handbuch für Automic Vault 4.12.2; anhand des aktuellen Quellcodes geprüft.",
        ...
        "release": "Aktuell dokumentiertes Release: Automic Vault 4.12.2",
    ...
    "fr": {
        ...
        "docsDescription": "Manuel anglais d’Automic Vault 4.12.2 ; vérifié sur le code source actuel.",
        ...
        "release": "Version actuellement documentée : Automic Vault 4.12.2",
    ...
    "zh-Hans": {
        ...
        "docsDescription": "英文 Automic Vault 4.12.2 手册；依据当前源码核对。",
        ...
        "facts": "关键信息",
        "platform": "平台：macOS",
        "release": "当前文档版本：Automic Vault 4.12.2",
...
def render_sitemap(records: list[dict[str, Any]], locales: list[Locale]) -> str:
    ...
    preserved = [
        ("https://www.automicvault.com/docs/", "2026-09-25"),
        ("https://www.automicvault.com/docs/security/", "2026-09-25"),
        ("https://www.automicvault.com/docs/app/", "2026-09-25"),
        ("https://www.automicvault.com/docs/authority/", "2026-09-25"),
        ("https://www.automicvault.com/docs/cli/", "2026-09-25"),
        ("https://www.automicvault.com/docs/workflows/", "2026-09-25"),
        ("https://www.automicvault.com/docs/reentrant-scripts/", "2026-09-25"),
        ("https://www.automicvault.com/docs/troubleshooting/", "2026-09-25"),
        ("https://www.automicvault.com/docs/hardeners/", "2026-09-25"),
        ("https://www.automicvault.com/blog/", "2026-09-23"),
        ("https://www.automicvault.com/blog/quickstart-to-launcher-bundles/", "2026-09-23"),
        ("https://www.automicvault.com/blog/automic-vault-vs-aws-secrets-manager/", "2026-08-14"),
        ("https://www.automicvault.com/blog/automic-vault-vs-hashicorp-vault/", "2026-08-14"),
        ("https://www.automicvault.com/blog/automic-vault-vs-infisical/", "2026-08-14"),
        ...
        ("https://www.automicvault.com/llms.txt", "2026-09-25"),
        ("https://www.automicvault.com/llms-full.txt", "2026-09-25"),
