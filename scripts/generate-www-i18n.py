...
LLMS_COPY: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "docsDescription": "Automic Vault 4.8.2 のアプリ、Approval、Project Values、Launcher Bundles、プロキシ、GPG Signing、CLI 全体を解説する英語のマニュアルです。",
    ...
    "de": {
        ...
        "docsDescription": "Englisches, quellgeprüftes Handbuch für Automic Vault 4.8.2 mit App, Approval, Project Values, Launcher Bundles, Proxy, GPG Signing und vollständiger CLI.",
    ...
    "fr": {
        ...
        "docsDescription": "Manuel anglais vérifié sur les sources d’Automic Vault 4.8.2, couvrant l’app, Approval, Project Values, Launcher Bundles, proxy, GPG Signing et toute la CLI.",
    ...
    "zh-Hans": {
        ...
        "docsDescription": "经源码核对的英文 Automic Vault 4.8.2 手册，涵盖应用、Approval、Project Values、Launcher Bundles、代理、GPG Signing 和完整 CLI。",
