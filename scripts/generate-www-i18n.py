...
LLMS_COPY: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "docsDescription": "Automic Vault のアプリ、Approval、Project Values、Launcher Bundles、プロキシ、GPG Signing、CLI を解説する英語のマニュアルです。一部は 4.6.0 のソースで検証されています。",
        ...
        "facts": "基本情報",
        "platform": "対応環境: macOS",
        "release": "現在のドキュメント対象リリース: Automic Vault 4.8.2",
    ...
    "de": {
        ...
        "docsDescription": "Englisches Handbuch für Automic Vault 4.8.2; einzelne Abschnitte wurden anhand des Quellcodes von 4.6.0 geprüft.",
        ...
        "release": "Aktuell dokumentiertes Release: Automic Vault 4.8.2",
    ...
    "fr": {
        ...
        "docsDescription": "Manuel anglais d’Automic Vault 4.8.2 ; certaines sections ont été vérifiées sur le code source de 4.6.0.",
        ...
        "release": "Version actuellement documentée : Automic Vault 4.8.2",
    ...
    "zh-Hans": {
        ...
        "docsDescription": "英文 Automic Vault 4.8.2 手册；部分章节依据 4.6.0 源码核对。",
        ...
        "facts": "关键信息",
        "platform": "平台：macOS",
        "release": "当前文档版本：Automic Vault 4.8.2",
...
def render_sitemap(records: list[dict[str, Any]], locales: list[Locale]) -> str:
    ...
    preserved = [
        ("https://www.automicvault.com/docs/", "2026-09-13"),
        ("https://www.automicvault.com/docs/security/", "2026-09-13"),
        ("https://www.automicvault.com/docs/app/", "2026-09-13"),
        ("https://www.automicvault.com/docs/authority/", "2026-09-13"),
        ("https://www.automicvault.com/docs/cli/", "2026-09-13"),
        ("https://www.automicvault.com/docs/workflows/", "2026-09-13"),
        ("https://www.automicvault.com/docs/reentrant-scripts/", "2026-09-13"),
        ("https://www.automicvault.com/docs/troubleshooting/", "2026-09-13"),
        ("https://www.automicvault.com/docs/hardeners/", "2026-09-13"),
