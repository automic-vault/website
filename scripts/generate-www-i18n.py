...
LLMS_COPY: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "docsDescription": "Automic Vault 3.16.0 のアプリ、Approval、Project Values、Launcher Bundles、プロキシ、GPG Signing、CLI 全体を解説する英語のマニュアルです。",
        ...
        "facts": "基本情報",
        "platform": "対応環境: macOS",
        "release": "現在のドキュメント対象リリース: Automic Vault 3.16.0",
    ...
    "de": {
        ...
        "docsDescription": "Englisches, quellgeprüftes Handbuch für Automic Vault 3.16.0 mit App, Approval, Project Values, Launcher Bundles, Proxy, GPG Signing und vollständiger CLI.",
        ...
        "release": "Aktuell dokumentiertes Release: Automic Vault 3.16.0",
    ...
    "fr": {
        ...
        "docsDescription": "Manuel anglais vérifié sur les sources d’Automic Vault 3.16.0, couvrant l’app, Approval, Project Values, Launcher Bundles, proxy, GPG Signing et toute la CLI.",
        ...
        "release": "Version actuellement documentée : Automic Vault 3.16.0",
    ...
    "zh-Hans": {
        ...
        "docsDescription": "经源码核对的英文 Automic Vault 3.16.0 手册，涵盖应用、Approval、Project Values、Launcher Bundles、代理、GPG Signing 和完整 CLI。",
        ...
        "facts": "关键信息",
        "platform": "平台：macOS",
        "release": "当前文档版本：Automic Vault 3.16.0",
...
def render_sitemap(records: list[dict[str, Any]], locales: list[Locale]) -> str:
    ...
    preserved = [
        ("https://www.automicvault.com/docs/", "2026-08-23"),
        ("https://www.automicvault.com/docs/security/", "2026-08-23"),
