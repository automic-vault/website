...
3. Improve: edit \`crates/av-web/main.rs\`, package metadata generation, or package i18n templates so the target query is answered in the HTML, markdown alternate, schema, and internal links.
4. Verify: run \`cargo test\`, spot-check rendered pages, and make sure the changed terms appear in title/H1/meta/markdown where appropriate.
